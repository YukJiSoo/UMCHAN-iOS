...
/// Input
public struct CrewInput: GraphQLMapConvertible {
  public var graphQLMap: GraphQLMap
...
public struct CreateCrewInput: GraphQLMapConvertible {
  ...
  public init(nickname: String, name: String, oneLine: String, district: String, creationDate: DateInput) {
    graphQLMap = ["nickname": nickname, "name": name, "oneLine": oneLine, "district": district, "creationDate": creationDate]
  }
...
public struct DisassembleCrewInput: GraphQLMapConvertible {
  public var graphQLMap: GraphQLMap
...
public struct CancelRunningInput: GraphQLMapConvertible {
  public var graphQLMap: GraphQLMap
...
public final class CrewListQuery: GraphQLQuery {
  ...
  /// }
  public let operationDefinition =
    "query CrewList($name: String) { crews(name: $name) { __typename code success message crews { __typename id name oneLine creationDate { __typename year month date hour minute } leader { __typename nickname userID } members { __typename nickname userID } awaitMembers { __typename nickname userID } district } } }"
    ...
    public struct Crew: GraphQLSelectionSet {
      ...
      public struct Crew: GraphQLSelectionSet {
        ...
        public struct Leader: GraphQLSelectionSet {
          ...
          public init(nickname: String? = nil, userId: String? = nil) {
            self.init(unsafeResultMap: ["__typename": "Member", "nickname": nickname, "userID": userId])
          }
...
public final class CrewQuery: GraphQLQuery {
  ...
  /// }
  public let operationDefinition =
    "query Crew($input: CrewInput) { crew(input: $input) { __typename code success message crew { __typename id name oneLine leader { __typename userID name nickname district } members { __typename userID name nickname district } awaitMembers { __typename userID name nickname district } creationDate { __typename year month date hour minute } district } isApplied isMember } }"

  public let operationName = "Crew"

  public var input: CrewInput?

  public init(input: CrewInput? = nil) {
    self.input = input
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("crew", arguments: ["input": GraphQLVariable("input")], type: .object(Crew.selections)),
    ]
    ...
    public init(crew: Crew? = nil) {
      self.init(unsafeResultMap: ["__typename": "Query", "crew": crew.flatMap { (value: Crew) -> ResultMap in value.resultMap }])
    }

    public var crew: Crew? {
      get {
        return (resultMap["crew"] as? ResultMap).flatMap { Crew(unsafeResultMap: $0) }
      }
      set {
        resultMap.updateValue(newValue?.resultMap, forKey: "crew")
      }
    }

    public struct Crew: GraphQLSelectionSet {
      public static let possibleTypes = ["CrewQueryResponse"]
      ...
      public static let selections: [GraphQLSelection] = [
        ...
        GraphQLField("success", type: .nonNull(.scalar(Bool.self))),
        GraphQLField("message", type: .nonNull(.scalar(String.self))),
        GraphQLField("crew", type: .nonNull(.object(Crew.selections))),
      ...
      public init(code: String, success: Bool, message: String, crew: Crew, isApplied: Bool? = nil, isMember: Bool? = nil) {
        self.init(unsafeResultMap: ["__typename": "CrewQueryResponse", "code": code, "success": success, "message": message, "crew": crew.resultMap, "isApplied": isApplied, "isMember": isMember])
      }
      ...
      public var crew: Crew {
        get {
          return Crew(unsafeResultMap: resultMap["crew"]! as! ResultMap)
        }
        set {
          resultMap.updateValue(newValue.resultMap, forKey: "crew")
        }
      ...
      public struct Crew: GraphQLSelectionSet {
        ...
        public init(id: GraphQLID? = nil, name: String? = nil, oneLine: String? = nil, leader: Leader? = nil, members: [Member?]? = nil, awaitMembers: [AwaitMember?]? = nil, creationDate: CreationDate? = nil, district: String? = nil) {
          self.init(unsafeResultMap: ["__typename": "Crew", "id": id, "name": name, "oneLine": oneLine, "leader": leader.flatMap { (value: Leader) -> ResultMap in value.resultMap }, "members": members.flatMap { (value: [Member?]) -> [ResultMap?] in value.map { (value: Member?) -> ResultMap? in value.flatMap { (value: Member) -> ResultMap in value.resultMap } } }, "awaitMembers": awaitMembers.flatMap { (value: [AwaitMember?]) -> [ResultMap?] in value.map { (value: AwaitMember?) -> ResultMap? in value.flatMap { (value: AwaitMember) -> ResultMap in value.resultMap } } }, "creationDate": creationDate.flatMap { (value: CreationDate) -> ResultMap in value.resultMap }, "district": district])
        }
...
public final class CreateCrewMutation: GraphQLMutation {
  ...
  /// }
  public let operationDefinition =
    "mutation CreateCrew($input: CreateCrewInput) { createCrew(input: $input) { __typename code success message } }"

  public let operationName = "CreateCrew"

  public var input: CreateCrewInput?

  public init(input: CreateCrewInput? = nil) {
    self.input = input
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("createCrew", arguments: ["input": GraphQLVariable("input")], type: .object(CreateCrew.selections)),
    ]
...
public final class DisassembleCrewMutation: GraphQLMutation {
  ...
  /// }
  public let operationDefinition =
    "mutation DisassembleCrew($input: DisassembleCrewInput) { disassembleCrew(input: $input) { __typename code success message } }"

  public let operationName = "DisassembleCrew"

  public var input: DisassembleCrewInput?

  public init(input: DisassembleCrewInput? = nil) {
    self.input = input
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("disassembleCrew", arguments: ["input": GraphQLVariable("input")], type: .object(DisassembleCrew.selections)),
    ]
    ...
    public init(disassembleCrew: DisassembleCrew? = nil) {
      self.init(unsafeResultMap: ["__typename": "Mutation", "disassembleCrew": disassembleCrew.flatMap { (value: DisassembleCrew) -> ResultMap in value.resultMap }])
    }

    public var disassembleCrew: DisassembleCrew? {
      get {
        return (resultMap["disassembleCrew"] as? ResultMap).flatMap { DisassembleCrew(unsafeResultMap: $0) }
      }
      set {
        resultMap.updateValue(newValue?.resultMap, forKey: "disassembleCrew")
      }
    }

    public struct DisassembleCrew: GraphQLSelectionSet {
      public static let possibleTypes = ["DisassembleCrewMutationResponse"]
...
public final class CancelRunningMutation: GraphQLMutation {
  ...
  /// }
  public let operationDefinition =
    "mutation CancelRunning($input: CancelRunningInput) { cancelRunning(input: $input) { __typename code success message } }"

  public let operationName = "CancelRunning"

  public var input: CancelRunningInput?

  public init(input: CancelRunningInput? = nil) {
    self.input = input
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("cancelRunning", arguments: ["input": GraphQLVariable("input")], type: .object(CancelRunning.selections)),
    ]
    ...
    public init(cancelRunning: CancelRunning? = nil) {
      self.init(unsafeResultMap: ["__typename": "Mutation", "cancelRunning": cancelRunning.flatMap { (value: CancelRunning) -> ResultMap in value.resultMap }])
    }

    public var cancelRunning: CancelRunning? {
      get {
        return (resultMap["cancelRunning"] as? ResultMap).flatMap { CancelRunning(unsafeResultMap: $0) }
      }
      set {
        resultMap.updateValue(newValue?.resultMap, forKey: "cancelRunning")
      }
    }

    public struct CancelRunning: GraphQLSelectionSet {
      public static let possibleTypes = ["CancelRunningMutationResponse"]
      ...
      public init(code: String, success: Bool, message: String) {
        self.init(unsafeResultMap: ["__typename": "CancelRunningMutationResponse", "code": code, "success": success, "message": message])
      }
