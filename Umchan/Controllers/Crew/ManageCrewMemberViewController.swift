...
class ManageCrewMemberViewController: UIViewController, NibLodable {
    ...
    var id: String?
    var district: String?
    var awaitMembers: [CrewQueryType.AwaitMember]?
    var members: [CrewQueryType.Member]?
...
extension ManageCrewMemberViewController: UITableViewDataSource {
...
extension ManageCrewMemberViewController: CustomNavigationBarDelegate {
